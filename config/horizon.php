...
return [
    ...
    */
    ...
    | Horizon when making decisions about which processes to terminate and
    | which processes to restart when deploying your application.
    |
    */
    ...
    'environments' => [
        ...
        'local' => [
            'supervisor-1' => [
                'connection' => 'redis',
                'queue' => ['default', 'emails', 'notifications', 'analytics'],
                'balance' => 'auto',
                'autoScalingStrategy' => 'time',
                'maxProcesses' => 3,
                'maxTime' => 0,
