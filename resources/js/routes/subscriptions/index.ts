...
/**
* @see \App\Http\Controllers\SubscriptionController::preferences
 * @see app/Http/Controllers/SubscriptionController.php:130
 * @route '/subscriptions/{subscription}/preferences'
 */
export const preferences = (args: { subscription: number | { id: number } } | [subscription: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
 ...
 * @route '/subscriptions/{subscription}/preferences'
 */
preferences.url = (args: { subscription: number | { id: number } } | [subscription: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
 ...
 * @route '/subscriptions/{subscription}/preferences'
 */
preferences.patch = (args: { subscription: number | { id: number } } | [subscription: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: preferences.url(args, options),
    method: 'patch',
})
...
boxes: Object.assign(boxes, boxes),
}
