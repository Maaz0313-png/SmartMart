...
/**
* @see \App\Http\Controllers\Admin\OrderController::markAsShipped
 * @see app/Http/Controllers/Admin/OrderController.php:138
 * @route '/admin/orders/{order}/ship'
 */
export const markAsShipped = (args: { order: number | { id: number } } | [order: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/admin/orders/{order}/ship'
 */
markAsShipped.url = (args: { order: number | { id: number } } | [order: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { order: args }
    }
 ...
 * @route '/admin/orders/{order}/ship'
 */
markAsShipped.post = (args: { order: number | { id: number } } | [order: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: markAsShipped.url(args, options),
    method: 'post',
})
...
const OrderController = { index, show, updateStatus, markAsShipped, bulkUpdate, analytics }
